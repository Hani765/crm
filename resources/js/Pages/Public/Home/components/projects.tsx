...
export default function IconSectionStackedCards() {
    return (
        <>
            <div className="container py-24 lg:py-32 bg-white">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            The simplest way to keep your portfolio always
                            up-to-date.
                        </CardContent>
                    </Card>
                    <Card>
                        ...
                        <CardContent>
                            New design projects delivered to your inbox each
                            morning.
                        </CardContent>
                    </Card>
                    {/* End Card */}
                    ...
                    <Card>
                        ...
                        <CardContent>
                            Get your goods in front of millions of potential
                            customers with ease.
                        </CardContent>
                    </Card>
                    {/* End Card */}
